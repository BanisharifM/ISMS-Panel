...
$(window).on("load", function() {
  $("#light-toolbar").toolbar({ content: "#toolbar-options", style: "light" });
  $("#dark-toolbar").toolbar({ content: "#toolbar-options", style: "dark" });
  ...
  $("#info-toolbar").toolbar({ content: "#toolbar-options", style: "info" });
